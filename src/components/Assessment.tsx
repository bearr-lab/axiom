...
export function Assessment() {
  ...
  if (!item) return <main className="completion-gate"><p className="eyebrow">Assessment complete</p><h1>Evidence captured</h1><p>Generate your projected benchmark from the decisions you have locked.</p><button className="primary-button" onClick={complete}>Generate benchmark →</button></main>;
